...
namespace Engine
{
	namespace TheoreticalProfile
	{
		...
		{			
			...
			//DOMImplementation* impl =  DOMImplementationRegistry::getDOMImplementation(XERCES_CPP_NAMESPACE::XMLString::transcode("Core"));
			...
			DOMWriter* theSerializer = ((DOMImplementationLS*)impl)((DOMImplementationLS*)impl)->createDOMWriter();
