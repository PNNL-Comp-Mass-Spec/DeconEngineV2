...
namespace Engine.HornTransform
{
    internal class MercuryCache
    {
            ...
            double mzSpacing, double threshold)
        {
            ...
            // separated peaks. So if there is a peak with just one point in it, there will be a discontinuous stretch on the x axis.
        ...
        /// <param name="mzs">Isotope m/z values</param>
